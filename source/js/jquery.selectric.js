    ...
    n.prototype = {
      ...
      setLabel: function() {
        ...
        if (t.state.multiple) {
          ...
          t.options.multiple.maxLabelEntries && (i.length >= t.options.multiple.maxLabelEntries + 1 ? (i = i.slice(0, t.options.multiple.maxLabelEntries)).push(e.isFunction(s) ? s({
            text: "..."
          }) : t.utils.format(s, {
            text: "..."
          })) : i.slice(i.length - 1)),
      ...
      isInViewport: function() {
        ...
        if (!0 === e.options.forceRenderAbove)
          ...
          var t = s.scrollTop()
            ...
            , n = i + e.elements.outerWrapper.outerHeight() + e.itemsHeight <= t + l
            , a = i - e.itemsHeight > t
            , o = !n && a
            , r = !o;
          e.elements.outerWrapper.toggleClass(e.classes.above, o),
            e.elements.outerWrapper.toggleClass(e.classes.below, r)
        }
      },
